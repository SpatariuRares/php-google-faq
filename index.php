    ...
    $posts=[
        ...
        [
            ...
            "list"=>[
                ...
                [
                    "answer"=>"La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali."
                ]
                ],
            "last"=>"Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account",
        ],
        [
...
<ul>
    ...
    foreach ($posts as $element) {
        ...
        <li>
            ...
            <?php
                if(array_key_exists("list", $element)){
                    ?>
                <ol>
                    <?php
                    foreach ($element["list"] as $listElement){
                        ?>
                    <li>
                        <?php echo $listElement["answer"]?>
                        <?php
                            if(array_key_exists("lists", $listElement)){
                        ?>
                            <ol>
                                <?php
                                    foreach ($listElement["lists"] as $internlistElement){
                                ?>
                                <li>
                                    <?php echo $internlistElement?>
                                </li>
                                <?php
                                    }
                                ?>
            ...
            ?>
            <?php if(array_key_exists("last", $element)){
            ?>
            <p><?php echo $element["last"]?></p>
            <?php }
            ?>
        </li>
    <?php
